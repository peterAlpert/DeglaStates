...
export class SharedService {
  ...
  controlOptions: string[] = [
    ...
    'دعاء احمد', 'جالا جمال', 'نورهان محمد', 'مريم يني', 'مريان اميل', 'المشرف'
  ];
  ...
  locationOptions: string[] = [
    'المبني الاجتماعي', 'مبني الاسبورت', 'مبني الخدمات', 'الكويسكات', 'الجاردن', 'التراك', 'البحيرة',
    'جاردن 1', 'جاردن 2', 'جاردن 3', 'الفتنس', 'الملاعب', 'المرحلة الثانيه', 'ملعب 1', 'ملعب 2', 'ملعب 3', 'ملعب 4',
    'رامب الاسبورت', 'رامب الاجتماعي', 'ضلع الاسبورت', 'ضلع الاجتماعي', 'ضلع 100 400', 'اللو كافيه'
  ];
